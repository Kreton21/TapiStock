...
func main() {
	...
	http.HandleFunc("/api/modifyProduct", handlers.RequireAuth(handlers.ModifyProduct))
	http.HandleFunc("/api/deleteProduct", handlers.RequireAuth(handlers.DeleteProduct))
